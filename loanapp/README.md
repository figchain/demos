...
A full-stack application demo that simulates a loan application system while using FigChain to manage configuration updates in realtime.
...
1. Create a schema in the namespace that you chose when creating a client credential, and call it `LoanAppParameters`. Create a Fig in the same namespace, give it a key of `parameters` and add a version. Set whatever values you want.
...
- Create a SQLite database (`loanapp.db`)
